...
export default function Component1() {
  ...
  return (
    <div>
      <div
        className="grid w-[90%] lg:w-[1000px] mx-auto mt-4 grid-cols-1 lg:grid-cols-2 lg:auto-rows-max lg:h-[1940px] auto-w
       lg:gap-4 2xl:grid-cols-[330px_minmax(400px,_1fr)_660px] 2xl:w-[1500px] 2xl:h-full 2xl:grid-rows-[300px_315px_250px]"
      >
        <div
          ...
          lg:order-first 2xl:col-start-1 2xl:col-end-2 2xl:row-start-1 2xl:row-end-2 2xl:h-full 2xl:pt-[20px]"
        >
        ...
        <div
          ...
          lg:row-start-1 lg:row-end-3 lg:col-start-2 lg:col-end-3 lg:order-2 2xl:order-2 2xl:col-start-2 2xl:col-end-3 2xl:row-start-1 2xl:row-end-4 "
        >
          ...
          <article className="text-justify text-white">
            ...
            I always enjoyed programming as casual hobby. My interest led me to experiment
          ...
          <article className="text-justify text-white">
            ...
            I expanded my skills to web development by using website
            builders such as <b className="text-color11">WIX</b> and editing websites using{" "}
            <b className="text-color11">WordPress</b>. I helped my wife with her business
          ...
          <article className="text-justify text-white">
            ...
            of <b className="text-color11">Object-Oriented Programming, C#, and Unity</b> engine. I
          ...
          <article className="text-justify text-white">
            ...
            After achieving certain career goals I realized that I need a new challenge.
            I've made a roadmap to learn modern front-end technologies, studied this whole year, and
            now I'm excited to join the IT industry.
          </article>
        </div>
        ...
        <div
         ...
         lg:justify-evenly 2xl:order-3 2xl:col-start-3 2xl:col-end-4 2xl:row-start-1 2xl:row-end-4 gap-2"
        >
          ...
          hover:-translate-y-1 rounded-2xl 2xl:w-[290px] 2xl:hover:scale-105 2xl:mb-0 2xl:flex-grow bg-opacity-70 hover:bg-opacity-100 2xl:p-2 2xl:h-[145px] group"
          >
            ...
            <div className="text-left pl-4 pr-4 pb-4">
              I'm a knowledge hoarder - I collect and keep everything I learn. Ask me anything!
          ...
          >
            ...
            <div className="text-left pl-4 pr-4 pb-4">
              I have an ability to use appropriate pieces of
          ...
          >
            ...
            <div className="text-left pl-4 pr-4 pb-4">
              As a coder, I find that paying attention to detail can be 
          ...
          >
            ...
            <div className="text-left pl-4 pr-4 pb-4">
              I put consistent effort towards achieving goals
               leading to sustained progress 
            </div>
          </div>
          ...
          rounded-2xl 2xl:w-[290px] 2xl:hover:scale-105 2xl:mb-0 2xl:flex-grow  bg-opacity-70 hover:bg-opacity-100 2xl:p-2 2xl:h-[145px] group"
          >
            <div className="flex justify-between items-center h-[55px] w-[350px] mx-auto 2xl:w-full 2xl:h-[38px]">
              <div className="w-[60%] h-[100%] flex justify-end items-center">
                <p className="text-color11 group-hover:text-amber-600 transition ease-in-out duration-300 font-bold text-[22px] leading-[22px] ">
        ...
        <div
          className="bg-neutral-300  p-4 m-2 shadow-xl rounded-3xl mx-auto w-[420px] h-full border-8  border-white
         md:w-[480px] lg:order-5 lg:col-start-1 lg:m-0 lg:col-end-3 lg:w-full 2xl:order-5 2xl:col-start-1 2xl:col-end-2 2xl:flex 2xl:items-center"
        >
